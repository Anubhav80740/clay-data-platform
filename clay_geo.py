...
FR_REGIONS = {
    "Île-de-France": [
        ...
        "Rungis", "Roissy-en-France", "Palaiseau", "Évry-Courcouronnes",
        "Montigny-le-Bretonneux", "Trappes", "Fontainebleau", "Marne-la-Vallée",
        "Bussy-Saint-Georges", "Torcy", "Chelles", "Meaux", "Melun", "Pontoise",
        "Nogent-sur-Marne", "Saint-Mandé", "Arcueil", "Gentilly", "Bourg-la-Reine",
        "Sceaux", "Châtenay-Malabry", "Le Plessis-Robinson", "Garches",
        "La Garenne-Colombes", "Bois-Colombes", "Villeneuve-la-Garenne",
        "Le Pré-Saint-Gervais", "Les Lilas", "Rosny-sous-Bois", "Bondy", "Drancy",
        "Le Blanc-Mesnil", "Aulnay-sous-Bois", "Sevran", "Livry-Gargan", "Villepinte",
    ],
    "Auvergne-Rhône-Alpes": [
        ...
        "Bourgoin-Jallieu", "Aix-les-Bains", "Voiron", "Oullins", "Écully",
        "Dardilly", "Limonest", "Tassin-la-Demi-Lune", "Sainte-Foy-lès-Lyon",
        "Saint-Genis-Laval", "Givors", "Craponne", "Chassieu", "Genas",
        "Saint-Fons", "Feyzin", "Corbas", "Mions", "Chaponost", "Brignais",
        "Fontaines-sur-Saône", "Neuville-sur-Saône", "Miribel", "Fontaine",
        "Saint-Martin-d'Hères", "Meylan", "Seyssinet-Pariset", "Saint-Égrève",
        "Crolles", "Montbonnot-Saint-Martin", "Albertville", "Sallanches",
        "Cluses", "Bonneville", "Saint-Julien-en-Genevois", "Gex",
        "Ferney-Voltaire", "Oyonnax", "Valserhône", "Aubenas", "Tournon-sur-Rhône",
        "Privas", "Yssingeaux", "Brioude", "Moulins", "Cusset", "Riom",
        "Chamalières", "Cournon-d'Auvergne", "Issoire", "Thiers", "Riorges",
        "Firminy", "Rive-de-Gier", "Montbrison", "Andrézieux-Bouthéon",
    ],
    "Provence-Alpes-Côte d'Azur": [
        ...
        "Mougins", "Villeneuve-Loubet", "Valbonne", "Carros", "Mandelieu-la-Napoule",
        "Cavaillon", "Carpentras", "Pertuis", "Orange", "Châteaurenard", "Gardanne",
        "Vitrolles", "Marignane", "Miramas", "Fos-sur-Mer", "Berre-l'Étang",
        "Allauch", "Plan-de-Cuques", "Pennes-Mirabeau", "Bouc-Bel-Air", "Cabriès",
        "Bandol", "Sanary-sur-Mer", "Ollioules", "Saint-Cyr-sur-Mer", "Cogolin",
        "Sainte-Maxime", "Saint-Tropez", "Brignoles", "Sorgues", "L'Isle-sur-la-Sorgue", "Bollène",
    ],
    "Occitanie": [
        ...
        "Muret", "Cugnaux", "Ramonville-Saint-Agne", "Castanet-Tolosan", "Balma",
        "L'Union", "Saint-Orens-de-Gameville", "Saint-Jean", "Plaisance-du-Touch",
        "Fonsorbes", "Castelnau-d'Estrétefonds", "Fronton", "Lavaur", "Gaillac",
        "Graulhet", "Mazamet", "Castelsarrasin", "Moissac", "Lourdes",
        "Bagnères-de-Bigorre", "Pamiers", "Foix", "Saint-Girons", "Lattes",
        "Mauguio", "Saint-Jean-de-Védas", "Pérols", "Juvignac", "Frontignan",
        "Mèze", "Balaruc-les-Bains", "Vias", "Grau-du-Roi", "Aigues-Mortes",
        "Beaucaire", "Saint-Gilles", "Vauvert", "Uzès", "Alès", "Bagnols-sur-Cèze",
        "Pont-Saint-Esprit", "Villeneuve-lès-Avignon", "Canet-en-Roussillon",
        "Saint-Estève", "Saint-Cyprien", "Argelès-sur-Mer", "Cabestany",
        "Lézignan-Corbières", "Limoux",
    ],
    "Nouvelle-Aquitaine": [
        ...
        "Gradignan", "Le Bouscat", "Cenon", "Lormont", "Bruges", "Floirac",
        "Eysines", "Blanquefort", "Ambarès-et-Lagrave", "Saint-Médard-en-Jalles",
        "Le Haillan", "Gujan-Mestras", "La Teste-de-Buch", "Arcachon",
        "Andernos-les-Bains", "Biscarrosse", "Tarnos", "Saint-Jean-de-Luz",
        "Hendaye", "Billère", "Lescar", "Lons", "Oloron-Sainte-Marie", "Orthez",
        "Soyaux", "Ruelle-sur-Touvre", "Panazol", "Couzeix", "Isle", "Malemort",
        "Tulle", "Ussel", "Bressuire", "Parthenay", "Thouars", "Châtelaillon-Plage",
        "Rochefort", "Royan", "Tonnay-Charente",
    ],
    "Hauts-de-France": [
...
FR_STATE_POSTAL = {
    "Île-de-France": [
        ...
        # 77 Seine-et-Marne
        "77000", "77100", "77127", "77144", "77184", "77185", "77200", "77240",
        "77290", "77300", "77340", "77400", "77500", "77600",
        # 78 Yvelines
        "78000", "78100", "78120", "78130", "78140", "78150", "78160", "78170",
        "78180", "78200", "78220", "78280", "78300", "78310", "78350", "78370",
        "78400", "78420", "78430", "78450", "78500", "78590", "78600", "78610",
        "78670", "78700", "78711", "78800", "78960",
        # 91 Essonne
        "91000", "91090", "91100", "91120", "91130", "91140", "91160", "91170",
        "91190", "91200", "91210", "91220", "91230", "91240", "91250", "91260",
        "91270", "91300", "91320", "91330", "91350", "91360", "91370", "91380",
        "91390", "91400", "91420", "91430", "91440", "91450", "91460", "91470",
        "91540", "91570", "91600", "91700", "91800", "91910", "91940",
        # 95 Val-d'Oise
        "95000", "95100", "95110", "95120", "95130", "95140", "95150", "95160",
        "95170", "95200", "95210", "95220", "95230", "95240", "95250", "95260",
        "95270", "95280", "95290", "95300", "95310", "95320", "95330", "95340",
        "95350", "95360", "95370", "95380", "95400", "95410", "95420", "95430",
        "95440", "95450", "95460", "95470", "95480", "95490", "95500", "95510",
        "95520", "95530", "95540", "95550", "95560", "95570", "95580", "95590",
        "95600", "95610", "95620", "95630", "95640", "95650", "95660", "95670",
        "95680", "95690", "95700", "95710", "95720", "95730", "95740", "95750",
        "95760", "95770", "95780", "95790", "95800", "95870",
    ],
    "Auvergne-Rhône-Alpes": [
        "69130", "69570", "69340", "69110", "69160", "69260", "69760", "69370", "69450", "69290", "69330", "69800",
        "38080", "38300", "38200", "38500", "38130", "38400", "38600", "38240", "38330", "38120", "38190",
        "74100", "74200", "74700", "74300", "74800", "74160", "74240", "74330", "74140", "74940", "74150",
        "73100", "73200", "73400", "73700", "73300",
        "42300", "42400", "42150", "42160", "42600", "42170",
        "63200", "63400", "63800", "63500", "63300", "63600",
        "01000", "01100", "01200", "01210", "01220", "01630", "01700", "01800",
        "26100", "26200", "26500", "26300",
    ],
    "Provence-Alpes-Côte d'Azur": [
        "13100", "13090", "13200", "13400", "13500", "13700", "13800", "13127", "13170", "13270", "13300", "13480", "13600",
        "06100", "06200", "06300", "06400", "06500", "06600", "06700", "06800", "06110", "06130", "06150", "06160", "06210", "06220", "06250", "06370", "06560",
        "83000", "83100", "83200", "83400", "83500", "83600", "83700", "83800", "83110", "83120", "83130", "83140", "83150", "83160", "83170", "83210", "83220", "83240", "83250", "83260", "83270", "83300", "83310", "83320", "83340", "83370", "83390", "83420", "83440", "83470", "83510", "83520", "83530", "83550", "83560", "83570", "83580", "83610", "83630", "83640", "83660", "83670", "83680", "83690", "83720", "83830", "83840", "83860", "83870", "83890", "83910", "83980",
        "84000", "84100", "84200", "84300", "84400", "84500", "84600", "84700", "84800",
    ],
}
